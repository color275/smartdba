# Generated by Django 3.0.6 on 2020-12-01 13:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('database', '0310_monitoritemlog_id_dbdetailmonitoritemlist'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_yn', models.CharField(blank=True, choices=[('1', 'Y'), ('0', 'N')], default='1', help_text='서버 사용 여부. N 일 경우 모든 이벤트(모니터링, Alert 등)에서 제외', max_length=30, null=True, verbose_name='사용여부')),
