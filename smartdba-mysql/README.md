...
docker run --name smartdba-mysql --network smartdba -v ${PWD}/custom:/etc/mysql/conf.d -v smartdba-db:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=admin -d -p 0.0.0.0:3306:3306 mysql:8.0
